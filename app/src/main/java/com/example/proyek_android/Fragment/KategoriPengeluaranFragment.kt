 ...
 * Use the [KategoriPengeluaranFragment.newInstance] factory method to
...
class KategoriPengeluaranFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment kategoriPengeluaranFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KategoriPengeluaranFragment().apply {
